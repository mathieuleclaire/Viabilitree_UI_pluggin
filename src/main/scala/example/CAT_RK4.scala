...
object CAT_RK4 {
  ...
  def compute_CAT_RK4(zeta: Double, l: Double, g: Double, M: Double, h: Double,
    ...
    def A(zeta: Double, l: Double, g: Double, M: Double, h: Double,
      ...
      Aprev * g * ( 1 - Aprev/ (1+ 1/(M/(1+eta*Tprev)))) - zeta*l*Aprev - p*Aprev
    }
    ...
    val k1_C = C(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev  , Aprev , Tprev )

    val k1_A = A(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev  , Aprev , Tprev )

    val k1_T = T(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev  , Aprev , Tprev )

    val k2_C = C(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )

    val k2_A = A(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )

    val k2_T = T(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )

    val k3_C = C(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )

    val k3_A = A(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )

    val k3_T = T(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )

    val k4_C = C(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )

    val k4_A = A(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )

    val k4_T = T(zeta, l, g , M , h , c , p , a , e , eta , eps
      , phi , d , delta , mp , mt , Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )
